...
const PendingListButtons = (props) => (
  <ButtonGroup className="float-right">
    <Complete handleClick={() => props.onListAcceptance(props.list)} testID="pending-list-accept" />
    <Trash handleClick={() => props.onListRejection(props.list)} testID="pending-list-trash" />
  </ButtonGroup>
);
